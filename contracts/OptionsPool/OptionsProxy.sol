...
contract OptionsProxy is OptionsData,baseProxy{
     ...
     *  amount  option's amount
     */
    function getBurnedFullPay(uint256 /*optionID*/,uint256 /*amount*/) public view returns(uint256){
        delegateToViewAndReturn();
    }
        /**
     ...
     */ 
    function setSharedState(uint256 /*newFirstOption*/,int256 /*latestNetWorth*/) public{
        delegateAndReturn();
    }
    /**
