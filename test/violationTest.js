...
contract('OptionsManagerV2', function (accounts){
    ...
    it('OptionsManagerV2 buy options violation test', async function (){
        ...
        fnx.approve(contracts.manager.address,deposit);
        await contracts.manager.addCollateral(deposit);
        fnx.approve(contracts.manager.address,1000000000000000);
        let tx = await contracts.manager.buyOption(1000000000000000,9000e8,1,month,10000000000,1);
        console.log(tx.receipt.gasUsed);  
        return;
        await testViolation("buy option invalid option type test failed",async function(){
            await contracts.manager.buyOption(1000000000000000,9000e8,1,month,10000000000,2,{value : 1000000000000000});    
        })
        await testViolation("buy option invalid input amount test failed",async function(){
            await contracts.manager.buyOption(10,9000e8,1,month,10000000000,0,{value : 10}); 
        })
        await testViolation("buy option invalid strike price test failed",async function(){
            await contracts.manager.buyOption(1000000000000000,90e8,1,month,10000000000,0,{value : 1000000000000000});     
        })
        await testViolation("buy option invalid settlement address test failed",async function(){
            await contracts.manager.buyOption(1000000000000000,9000e8,1,month,10000000000,0,{value : 1000000000000000});     
        })
        await testViolation("buy option invalid underlying test failed",async function(){
            await contracts.manager.buyOption(1000000000000000,9000e8,5,month,10000000000,0,{value : 1000000000000000});     
        })
        await testViolation("buy option invalid expiration test failed",async function(){
            await contracts.manager.buyOption(1000000000000000,9000e8,1,6*60*60*24,10000000000,0,{value : 1000000000000000});     
        })
        await testViolation("buy option not allowed test failed",async function(){
            await contracts.manager.buyOption(1000000000000000,9000e8,1,month,10000000000,0,{from:accounts[1],value : 1000000000000000});     
        })
        await contracts.manager.buyOption(1000000000000000,9000e8,1,month,10000000000,0,{from:accounts[2],value : 1000000000000000});     
